...
typedef struct _Device_cb
{
 ...
 /* Control Endpoints*/
  ...
  uint8_t  *(*GetHSConfigDescriptor)(uint8_t speed, uint16_t *length);
  uint8_t  *(*GetFSConfigDescriptor)(uint8_t speed, uint16_t *length);
  uint8_t  *(*GetOtherSpeedConfigDescriptor)(uint8_t speed, uint16_t *length);
  uint8_t  *(*GetDeviceQualifierDescriptor)(uint8_t speed, uint16_t *length);
