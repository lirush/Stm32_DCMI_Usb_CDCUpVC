...
USB_OTG_STS USB_OTG_CoreInit(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  if (pdev->cfg.phy_itface == USB_OTG_ULPI_PHY)
  {
    ...
    usbcfg.b.ulpi_utmi_sel     = 0; /* ULPI seleInterfacect */	//for HS mode it is reserv bit
    
    usbcfg.b.phyif             = 0; /* 8 bits */ //for HS mode it is reserv bit
    usbcfg.b.ddrsel            = 0; /* single data rate */ //for HS mode it is reserv bit
...
USB_OTG_STS  USB_OTG_DevConnect(USB_OTG_CORE_HANDLE *pdev)
{
